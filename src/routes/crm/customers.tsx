...
import { IconArrowRight, IconEdit, IconPlus, IconTrash } from "@tabler/icons-react";
...
function CustomersPage() {
  ...
  const sortedCustomers = useMemo(() => [...customers].sort((firstCustomer, secondCustomer) => secondCustomer.id - firstCustomer.id), [customers]);
          ...
          <Table verticalSpacing="md" horizontalSpacing="md" highlightOnHover>
            <Table.Thead>
              <Table.Tr>
                ...
                <Table.Th className="whitespace-nowrap">{CrmTexts.Customers.Table.City}</Table.Th>
            ...
            <Table.Tbody>
              {sortedCustomers.length > 0 ? (
                ...
                <Table.Tr>
                  <Table.Td colSpan={14} className="py-10 text-center text-slate-500">
                    {CrmTexts.Customers.Table.EmptyState}
                  </Table.Td>
                </Table.Tr>
              )}
            </Table.Tbody>
